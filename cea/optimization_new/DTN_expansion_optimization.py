"""
DTN Expansion Optimization
=============================
A workflow to stage the expansion of an existing (cluster‑0) District Thermal
Network (DTN) into selected number of phases while maximizing a financial
objective (ROI, NPV) or minimizing operational emissions under financial/environmental constraints
