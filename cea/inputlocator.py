...
class InputLocator(object):
    ...
    def get_dtn_cluster_nodes_file(self):
        """
        Returns the path to the cluster nodes CSV file.
        
        Returns:
        --------
        str
            Path to the cluster nodes CSV file
        """
        return os.path.join(self.get_dtn_expansion_optimization_results_folder(), 'cluster_nodes.csv')
        
    def get_dynamic_dtn_optimization_folder(self):
        """
        Returns the folder containing the scenario's dynamic DTN optimization results
        
        Returns:
        --------
        str
            Path to the dynamic DTN optimization folder
        """
        return self._ensure_folder(self.scenario, 'outputs', 'data', 'optimization', 'dynamic_dtn_optimization')
    ...
    def get_dynamic_dtn_optimization_results_folder(self):
        ...
        --------
        str
            Path to the dynamic DTN optimization results folder
        """
        return self._ensure_folder(self.get_dynamic_dtn_optimization_folder(), 'rerun_results')

    def get_dynamic_dtn_optimization_temp_scenario_folder(self):
        """
        Returns the folder containing the temporary scenario for dynamic DTN optimization
    ...
    def get_dynamic_dtn_optimization_modified_demands_folder(self):
        """
        Returns the folder containing the modified demand files for dynamic DTN optimization
        
        Returns:
        --------
        str
            Path to the modified demands folder
        """
        return self._ensure_folder(self.get_dynamic_dtn_optimization_folder(), 'modified_demands')

    def get_dynamic_dtn_optimization_thermal_network_folder(self):
        """
        Returns the folder containing the thermal network results for dynamic DTN optimization
        
        Returns:
        --------
        str
            Path to the thermal network results folder
        """
        return self._ensure_folder(self.get_dynamic_dtn_optimization_folder(), 'thermal_network')

    def get_dynamic_dtn_optimization_updated_metrics_folder(self):
        """
        Returns the folder containing the updated metrics for dynamic DTN optimization
        
        Returns:
        --------
        str
            Path to the updated metrics folder
        """
        return self._ensure_folder(self.get_dynamic_dtn_optimization_folder(), 'updated_metrics')

    def get_dynamic_dtn_optimization_updated_metrics_file(self):
        """
        Returns the file containing the updated metrics for dynamic DTN optimization
        
        Returns:
        --------
        str
            Path to the updated metrics file
        """
        return os.path.join(self.get_dynamic_dtn_optimization_updated_metrics_folder(), 'clusters_metrics_updated.csv')

    def get_dynamic_dtn_optimization_phase_supply_files_folder(self):
        """
        Returns the folder containing the phase supply files for dynamic DTN optimization
        
        Returns:
        --------
        str
            Path to the phase supply files folder
        """
        return self._ensure_folder(self.get_dynamic_dtn_optimization_results_folder(), 'phase_supply_files')

    def get_dynamic_dtn_optimization_phase_supply_file(self, phase):
        """
        Returns the supply file for a specific phase in dynamic DTN optimization
        ...
        --------
        str
            Path to the phase supply file
        """
        return os.path.join(self.get_dynamic_dtn_optimization_phase_supply_files_folder(), f'phase{phase}_supply.csv')
        
    def get_dynamic_dtn_network_layout_costs_file(self, network_type, network_name=""):
        """
        Returns the path to the network layout costs file generated by dynamic DTN optimization.
        ...
        --------
        str
            Path to the network layout costs file
        """
        file_name = f"{network_type}_costs.csv"
        return os.path.join(self.get_dynamic_dtn_optimization_thermal_network_folder(), file_name)

    def get_dynamic_dtn_thermal_network_layout_massflow_edges_file(self, network_type, network_name=""):
        """
        Returns the path to the thermal network layout massflow edges file generated by dynamic DTN optimization.
        ...
        --------
        str
            Path to the thermal network layout massflow edges file
        """
        if not network_name:
            file_name = f"{network_type}__massflow_edges_kgs.csv"
        else:
            file_name = f"{network_type}_{network_name}_massflow_edges_kgs.csv"
        return os.path.join(self.get_dynamic_dtn_optimization_thermal_network_folder(), file_name)

    def get_dynamic_dtn_thermal_network_layout_massflow_nodes_file(self, network_type, network_name=""):
        """
        Returns the path to the thermal network layout massflow nodes file generated by dynamic DTN optimization.
        ...
        --------
        str
            Path to the thermal network layout massflow nodes file
        """
        if not network_name:
            file_name = f"{network_type}__massflow_nodes_kgs.csv"
        else:
            file_name = f"{network_type}_{network_name}_massflow_nodes_kgs.csv"
        return os.path.join(self.get_dynamic_dtn_optimization_thermal_network_folder(), file_name)

    def get_dynamic_dtn_thermal_network_velocity_edges_file(self, network_type, network_name=""):
        """
        Returns the path to the thermal network velocity edges file generated by dynamic DTN optimization.
        ...
        --------
        str
            Path to the thermal network velocity edges file
        """
        if not network_name:
            file_name = f"{network_type}__velocity_edges_mpers.csv"
        else:
            file_name = f"{network_type}_{network_name}_velocity_edges_mpers.csv"
        return os.path.join(self.get_dynamic_dtn_optimization_thermal_network_folder(), file_name)

    def get_dynamic_dtn_network_pressure_at_nodes(self, network_type, network_name=""):
        """
        Returns the path to the network pressure at nodes file generated by dynamic DTN optimization.
        ...
        --------
        str
            Path to the network pressure at nodes file
        """
        if not network_name:
            file_name = f"{network_type}__pressure_at_nodes_Pa.csv"
        else:
            file_name = f"{network_type}_{network_name}_pressure_at_nodes_Pa.csv"
        return os.path.join(self.get_dynamic_dtn_optimization_thermal_network_folder(), file_name)

    def get_dynamic_dtn_network_total_pressure_drop_file(self, network_type, network_name=""):
        """
        Returns the path to the network total pressure drop file generated by dynamic DTN optimization.
        ...
        --------
        str
            Path to the network total pressure drop file
        """
        if not network_name:
            file_name = f"{network_type}__pressure_loss_system.csv"
        else:
            file_name = f"{network_type}_{network_name}_pressure_loss_system.csv"
        return os.path.join(self.get_dynamic_dtn_optimization_thermal_network_folder(), file_name)

    def get_dynamic_dtn_network_energy_pumping_requirements_file(self, network_type, network_name=""):
        """
        Returns the path to the network energy pumping requirements file generated by dynamic DTN optimization.
        ...
        --------
        str
            Path to the network energy pumping requirements file
        """
        if not network_name:
            file_name = f"{network_type}__pumping_energy_system.csv"
        else:
            file_name = f"{network_type}_{network_name}_pumping_energy_system.csv"
        return os.path.join(self.get_dynamic_dtn_optimization_thermal_network_folder(), file_name)

    def get_dynamic_dtn_thermal_network_substation_ploss_file(self, network_type, network_name=""):
        """
        Returns the path to the thermal network substation pressure loss file generated by dynamic DTN optimization.
        ...
        --------
        str
            Path to the thermal network substation pressure loss file
        """
        if not network_name:
            file_name = f"{network_type}__pumping_load_due_to_substations_kW.csv"
        else:
            file_name = f"{network_type}_{network_name}_pumping_load_due_to_substations_kW.csv"
        return os.path.join(self.get_dynamic_dtn_optimization_thermal_network_folder(), file_name)

    def get_dynamic_dtn_network_linear_pressure_drop_edges(self, network_type, network_name=""):
        """
        Returns the path to the network linear pressure drop edges file generated by dynamic DTN optimization.
        ...
        --------
        str
            Path to the network linear pressure drop edges file
        """
        if not network_name:
            file_name = f"{network_type}__linear_pressure_drop_edges_Paperm.csv"
        else:
            file_name = f"{network_type}_{network_name}_linear_pressure_drop_edges_Paperm.csv"
        return os.path.join(self.get_dynamic_dtn_optimization_thermal_network_folder(), file_name)

    def get_dynamic_dtn_network_total_thermal_loss_file(self, network_type, network_name=""):
        """
        Returns the path to the network total thermal loss file generated by dynamic DTN optimization.
        ...
        --------
        str
            Path to the network total thermal loss file
        """
        if not network_name:
            file_name = f"{network_type}__thermal_loss_system.csv"
        else:
            file_name = f"{network_type}_{network_name}_thermal_loss_system.csv"
        return os.path.join(self.get_dynamic_dtn_optimization_thermal_network_folder(), file_name)

    def get_dynamic_dtn_network_thermal_loss_edges_file(self, network_type, network_name=""):
        """
        Returns the path to the network thermal loss edges file generated by dynamic DTN optimization.
        ...
        --------
        str
            Path to the network thermal loss edges file
        """
        if not network_name:
            file_name = f"{network_type}__thermal_loss_edges.csv"
        else:
            file_name = f"{network_type}_{network_name}_thermal_loss_edges.csv"
        return os.path.join(self.get_dynamic_dtn_optimization_thermal_network_folder(), file_name)

    def get_dynamic_dtn_network_linear_thermal_loss_edges_file(self, network_type, network_name=""):
        """
        Returns the path to the network linear thermal loss edges file generated by dynamic DTN optimization.
        ...
        --------
        str
            Path to the network linear thermal loss edges file
        """
        if not network_name:
            file_name = f"{network_type}__linear_thermal_loss_edges.csv"
        else:
            file_name = f"{network_type}_{network_name}_linear_thermal_loss_edges.csv"
        return os.path.join(self.get_dynamic_dtn_optimization_thermal_network_folder(), file_name)

    def get_dynamic_dtn_thermal_network_pressure_losses_edges_file(self, network_type, network_name=""):
        """
        Returns the path to the thermal network pressure losses edges file generated by dynamic DTN optimization.
        ...
        --------
        str
            Path to the thermal network pressure losses edges file
        """
        if not network_name:
            file_name = f"{network_type}__pressure_losses_edges_kW.csv"
        else:
            file_name = f"{network_type}_{network_name}_pressure_losses_edges_kW.csv"
        return os.path.join(self.get_dynamic_dtn_optimization_thermal_network_folder(), file_name)

    def get_dynamic_dtn_thermal_network_plant_heat_requirement_file(self, network_type, network_name=""):
        """
        Returns the path to the thermal network plant heat requirement file generated by dynamic DTN optimization.
        ...
        --------
        str
            Path to the thermal network plant heat requirement file
        """
        if not network_name:
            file_name = f"{network_type}__plant_thermal_load_kW.csv"
        else:
            file_name = f"{network_type}_{network_name}_plant_thermal_load_kW.csv"
        return os.path.join(self.get_dynamic_dtn_optimization_thermal_network_folder(), file_name)

    def get_dynamic_dtn_network_temperature_supply_nodes_file(self, network_type, network_name=""):
        """
        Returns the path to the network temperature supply nodes file generated by dynamic DTN optimization.
        ...
        --------
        str
            Path to the network temperature supply nodes file
        """
        if not network_name:
            file_name = f"{network_type}__temperature_supply_nodes_K.csv"
        else:
            file_name = f"{network_type}_{network_name}_temperature_supply_nodes_K.csv"
        return os.path.join(self.get_dynamic_dtn_optimization_thermal_network_folder(), file_name)

    def get_dynamic_dtn_network_temperature_return_nodes_file(self, network_type, network_name=""):
        """
        Returns the path to the network temperature return nodes file generated by dynamic DTN optimization.
        ...
        --------
        str
            Path to the network temperature return nodes file
        """
        if not network_name:
            file_name = f"{network_type}__temperature_return_nodes_K.csv"
        else:
            file_name = f"{network_type}_{network_name}_temperature_return_nodes_K.csv"
        return os.path.join(self.get_dynamic_dtn_optimization_thermal_network_folder(), file_name)

    def get_dynamic_dtn_network_temperature_plant(self, network_type, network_name=""):
        """
        Returns the path to the network temperature plant file generated by dynamic DTN optimization.
        ...
        --------
        str
            Path to the network temperature plant file
        """
        if not network_name:
            file_name = f"{network_type}__temperature_plant_K.csv"
        else:
            file_name = f"{network_type}_{network_name}_temperature_plant_K.csv"
        return os.path.join(self.get_dynamic_dtn_optimization_thermal_network_folder(), file_name)
